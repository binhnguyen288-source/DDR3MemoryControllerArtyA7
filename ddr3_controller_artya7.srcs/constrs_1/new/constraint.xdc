...
create_clock -period 10.00 [get_ports { osc }];
...
set_property -dict { PACKAGE_PIN U9 IOSTANDARD DIFF_SSTL135 } [get_ports {ddr3_ck_p}]
set_property -dict { PACKAGE_PIN V9 IOSTANDARD DIFF_SSTL135 } [get_ports {ddr3_ck_n}]
...
set_property -dict { PACKAGE_PIN N5 IOSTANDARD SSTL135 } [get_ports {ddr3_cke}]
set_property -dict { PACKAGE_PIN R5 IOSTANDARD SSTL135 } [get_ports {ddr3_odt}]
